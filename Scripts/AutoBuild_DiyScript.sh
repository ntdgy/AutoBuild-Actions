...
Firmware-Diy() {
	...
	d-team_newifi-d2)
		...
		Replace_File CustomFiles/system_d-team_newifi-d2 package/base-files/files/etc/config system
		 AddPackage git https://github.com/immortalwrt/luci-app-unblockneteasemusic.git luci-app-unblockneteasemusic https://github.com/immortalwrt/luci-app-unblockneteasemusic.git master
